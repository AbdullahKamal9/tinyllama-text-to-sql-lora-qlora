...
Fine-tuned TinyLlama-1.1B-Chat to generate SQL queries from natural-language questions and a database schema, comparing two parameter-efficient fine-tuning approaches — LoRA and QLoRA — on the same task, same data, and same adapter configuration.
...
b-mc2/sql-create-context — natural language question + CREATE TABLE schema pairs mapped to the corresponding SQL query.
